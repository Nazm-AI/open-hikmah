...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-bg">
      ...
      <main className="mx-auto w-full max-w-[1180px] flex-1 px-6 pt-20 pb-16 md:px-12 md:pt-24">
        ...
        <p className="mt-5 max-w-[52ch] text-[18px] leading-relaxed text-text-secondary">
